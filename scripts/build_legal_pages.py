...
FOOTER = """<footer>
  <div class="wrap">
    ...
    <div class="footer-trust"><a href="/tools/">Free tools</a> &middot; <a href="/compare/">Comparisons</a> &middot; <a href="/pricing/">Pricing</a> &middot; <a href="/security/">Security</a> &middot; <a href="/privacy/">Privacy</a> &middot; <a href="/terms/">Terms</a></div>
...
TERMS = f"""<main>
  <div class="wrap">
    ...
    <div class="lawyer" style="margin-top:36px;">
      <p><strong>Deliberately not included:</strong> a governing law clause, a jurisdiction clause and a dispute resolution procedure. Those depend on where RecoverFlow is formally established and getting them wrong is worse than leaving them out, so they are being added properly with advice rather than guessed at here.</p>
    </div>
  </div>
</main>"""
